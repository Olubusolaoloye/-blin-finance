...
import { Bell, X, Check, Trash2, Calendar, ShieldCheck } from 'lucide-react';
          ...
          <>
            ...
            >
              ...
              <div className="p-3 bg-surface-raised border-t border-border-light text-center">
                <button className="text-[12px] font-bold text-brand-accent hover:underline">View All Notifications</button>
              </div>
            </motion.div>
          </>
        )}
