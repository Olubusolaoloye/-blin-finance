...
export function KYCPrompt({ onVerify }: { onVerify: () => void }) {
    ...
    >
      <BlinCard className="max-w-md w-full text-center border-brand-gold/30 bg-gradient-to-br from-[#FFFDF5] to-white shadow-lg">
        ...
        <p className="text-[15px] text-text-secondary mb-8 leading-relaxed">
          To comply with regulatory requirements and ensure the security of your account, please
          complete your KYC verification before trading stocks.
        </p>
