...
type BadgeVariant = "success" | "warning" | "error" | "info" | "locked" | "neutral";

interface BlinBadgeProps {
...
export function BlinBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center px-[10px] py-1 rounded-full font-body font-semibold text-[12px]",
        variants[variant],
        className,
      )}
    >
